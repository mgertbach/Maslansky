...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'mas' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'mas' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'mas' ),
		'repeat'    => esc_html__( 'Repeat All', 'mas' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'mas' ),
		'top center'    => esc_html__( 'Top Center', 'mas' ),
		'top right'     => esc_html__( 'Top Right', 'mas' ),
		'center left'   => esc_html__( 'Middle Left', 'mas' ),
		'center center' => esc_html__( 'Middle Center', 'mas' ),
		'center right'  => esc_html__( 'Middle Right', 'mas' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'mas' ),
		'bottom center' => esc_html__( 'Bottom Center', 'mas' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'mas')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'mas' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'mas')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'mas' ),
		'italic'      => esc_html__( 'Italic', 'mas' ),
		'bold'        => esc_html__( 'Bold', 'mas' ),
		'bold italic' => esc_html__( 'Bold Italic', 'mas' )
		);
